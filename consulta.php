...
<!DOCTYPE html>
    ...
    <head>
           ...
           <!-- aca estamos referenciando hojas de estilos en css para el diseño de nuestra pagina -->
...
<body>
                    ...
                    <!-- Se establece el titulo que aparecera en pantalla "INSTRUCTOR" -->
                    <h2 align="center">
                      INSTRUCTOR
                    </h2>
...
if (empty($buscar)) {
    $busqueda=$conexion->query("Select * from instructor where status = 0");
    //Almacenamos el resultado de fetchAll en una variable/
}else {
    $busqueda= $conexion->query("select * from instructor where nombre_ins = '$buscar' or apellido_ins = '$buscar' or documento_ins = '$buscar' 
    or titulo_ins= '$buscar' or tipoSangre_ins= '$buscar' or eps_ins= '$buscar' or genero_ins= '$buscar' or correoSena_ins= '$buscar'
    or tipoDoc_ins= '$buscar' and status=0");
}
?>
...
<table   class="table table-bordered">
   ...
   /*var_dump($arrDatos);*/
   //Recorremos todos los resultados con un ciclo para que los asigne a cada campo de la tabla
   foreach ($arrDatos as $muestra) {
    //se nombra una cadena $datos con todos los datos de la tabla instructor, los cuales enviara a la pantalla modal
    $datos= $muestra->id_ins.'||'.$muestra->documento_ins.'||'.$muestra->tipoDoc_ins.'||'.$muestra->nombre_ins.'||'.$muestra->apellido_ins.'||'.$muestra->correoSena_ins.'||'.$muestra->celular_ins.
    '||'.$muestra->titulo_ins.'||'.$muestra->tipoSangre_ins.'||'.$muestra->eps_ins.'||'.$muestra->genero_ins;


       ?>
   <!-- El echo mostrara cada dato en la tabla, en la variable "muestra" esta cada dato de la tabla -->
        <tr>
        <td><?php echo $muestra->documento_ins ?></td>
        <td><?php echo $muestra->tipoDoc_ins ?></td>
        <td><?php echo $muestra->nombre_ins ?></td>
        <td><?php echo $muestra->apellido_ins ?></td>
        <td><?php echo $muestra->correoSena_ins ?></td>
        <td><?php echo $muestra->celular_ins ?></td>
        <td><?php echo $muestra->titulo_ins ?></td>
        <td><?php echo $muestra->tipoSangre_ins ?></td>
        <td><?php echo $muestra->eps_ins ?></td>
        <td><?php echo $muestra->genero_ins ?></td>
        ...
        <td><lu><a class="btn btn-danger ajax-request"  data-bs-toggle="modal" data-bs-target="#eliminar" onclick="preguntarSiNo('<?php echo $muestra->id_ins;?>');">Eliminar</a></lu></td>
        </tr>
    ...
    <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <input class="form-control w-100  ml-1 mr-1" type="text" id="documento_ins">
                    <label class="font-weight-bold ml-1 mt-2 ">Tipo de Documento</label>
                    <select class="form-control h-100 w-100 ml-1 mr-1 text-start" id="tipoDoc_ins">
                    <option value="CC">c.c</option>
                    <option value="TI">t.i</option>
                    <option value="CE">c.e</option>
                    </select>
                    <label class="font-weight-bold ml-1 mt-2 ">Nombre</label>
                    <input class="form-control w-100  ml-1 mr-1" type="text" id="nombre_ins">
                    <label class="font-weight-bold ml-1 mt-2 ">Apellido</label>
                    <input class="form-control w-100  ml-1 mr-1" type="text" id="apellido_ins">
                    <label class="font-weight-bold ml-1 mt-2 ">Correo</label>
                    <input class="form-control w-100  ml-1 mr-1" type="text" id="correoSena_ins">
                    <label class="font-weight-bold ml-1 mt-2 ">Celular</label>
                    <input class="form-control w-100  ml-1 mr-1" type="text" id="celular_ins">
                    <label class="font-weight-bold ml-1 mt-2 ">Titulo</label>
                    <input class="form-control w-100  ml-1 mr-1" type="text" id="titulo_ins">
                    <label class="font-weight-bold ml-1 mt-2 ">Tipo de Sangre</label>
                    <input class="form-control w-100  ml-1 mr-1" type="text" id="tipoSangre_ins">
                    <label class="font-weight-bold ml-1 mt-2 ">EPS</label>
                    <input class="form-control w-100  ml-1 mr-1" type="text" id="eps_ins">
                    <label class="font-weight-bold ml-1 mt-2 ">Genero</label>
                    <input class="form-control w-100  ml-1 mr-1" type="text" id="genero_ins">
    ...
    <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <label class="font-weight-bold ml-1 mt-2 ">Documento</label>
                    <input class="form-control w-100  ml-1 mr-1" type="text" id="documento_ins1">
                    <label class="font-weight-bold ml-1 mt-2 ">Tipo de Documento</label>
                    <select class="form-control h-100 w-100 ml-1 mr-1 text-start" id="tipoDoc_ins1">
                    <option value="CC">c.c</option>
                    <option value="TI">t.i</option>
                    <option value="CE">c.e</option>
                    </select>
                    <label class="font-weight-bold ml-1 mt-2 ">Nombre</label>
                    <input class="form-control w-100  ml-1 mr-1" type="text" id="nombre_ins1">
                    <label class="font-weight-bold ml-1 mt-2 ">Apellido</label>
                    <input class="form-control w-100  ml-1 mr-1" type="text" id="apellido_ins1">
                    <label class="font-weight-bold ml-1 mt-2 ">Correo</label>
                    <input class="form-control w-100  ml-1 mr-1" type="text" id="correoSena_ins1">
                    <label class="font-weight-bold ml-1 mt-2 ">Celular</label>
                    <input class="form-control w-100  ml-1 mr-1" type="text" id="celular_ins1">
                    <label class="font-weight-bold ml-1 mt-2 ">Titulo</label>
                    <input class="form-control w-100  ml-1 mr-1" type="text" id="titulo_ins1">
                    <label class="font-weight-bold ml-1 mt-2 ">Ficha asignada</label>
                    <input class="form-control w-100  ml-1 mr-1" type="text" id="ficha1">
                    <label class="font-weight-bold ml-1 mt-2 ">Contraseña</label>
                    <input class="form-control w-100  ml-1 mr-1" type="text" id="contrasena1">
                    <label class="font-weight-bold ml-1 mt-2 ">Tipo de Sangre</label>
                    <input class="form-control w-100  ml-1 mr-1" type="text" id="tipoSangre_ins1">
                    <label class="font-weight-bold ml-1 mt-2 ">EPS</label>
                    <input class="form-control w-100  ml-1 mr-1" type="text" id="eps_ins1">
                    <label class="font-weight-bold ml-1 mt-2 ">Genero</label>
                    <input class="form-control w-100  ml-1 mr-1" type="text" id="genero_ins1">
...
<!-- Se hace referencia añ archivo actualizarUsuario.js el cual nos actualizara los datos en la bd -->
